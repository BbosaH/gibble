...
var _redux_store = __webpack_require__(40);
...
var store = (0, _redux_store.config)();
...
var _combined_reducer = __webpack_require__(58);

var _combined_reducer2 = _interopRequireDefault(_combined_reducer);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var config = exports.config = function config() {
  var initalState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};


  var store = (0, _redux.createStore)(_combined_reducer2.default, initalState, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, _logging.ActionLogging, _logging.StateLogging), window.devToolsExtension ? window.devToolsExtension() : function (f) {
    return f;
  }));
...
var StateLogging = exports.StateLogging = function StateLogging(_ref) {
...
var ActionLogging = exports.ActionLogging = function ActionLogging(_ref2) {
